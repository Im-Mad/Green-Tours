...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaW0tbWFkIiwiYSI6ImNrdWZhNGc0MzBnY2kyb3FlbGh3bXN4ZG0ifQ.SZ-hVvoO_bWPfWpBW2Ambg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/im-mad/ckufaqs5o1g6w18unaoyol7sk',
...
var stripe = Stripe('pk_test_51JjqwXAWFY0OBXH9zCYdPJ45I1TMJt2RuqqDXOhJNOjfTNq0GDhwa45VYGPzMyLyuLuxjOiAoFKPU2EmaYG1bRcp000yq5Ex4T');
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 7:
              document.querySelector('.btn--saveSettings').textContent = 'SAVE PASSWORD';
